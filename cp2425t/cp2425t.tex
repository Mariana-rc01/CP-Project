...
Para definir o catamorfismo monádico de \ensuremath{\Conid{Expr}}, a função \ensuremath{\Varid{mcataExpr}}, começamos por definir a função \ensuremath{\Varid{dl'}}, que é responsável por transformar a estrutura de \ensuremath{\Conid{Expr}} para um contexto monádico.
