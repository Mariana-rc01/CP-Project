...
\column{7}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{smallestPrimeFactor}\mathbin{::}(\mathbb{Z},\mathbb{Z})\to \mathbb{Z}{}\<[E]%
\\
\>[B]{}\Varid{smallestPrimeFactor}\mathrel{=}\Varid{cond}\;(\uncurry{(\mathbin{>})}\comp ((\mathbin{\uparrow}\mathrm{2})\times\Varid{id}))\;\p2{}\<[E]%
\\
\>[B]{}\hsindent{7}{}\<[7]%
\>[7]{}(\Varid{cond}\;((\equiv \mathrm{0})\comp \uncurry{\Varid{mod}}\comp \Varid{swap})\;\p1\;(\Varid{smallestPrimeFactor}\comp (\succ \times\Varid{id}))){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{g}\;\mathrm{1}\mathrel{=}i_1\;(){}\<[E]%
\\
\>[B]{}\Varid{g}\;\Varid{n}\mathrel{=}i_2\;(\Varid{smallestPrimeFactor}\;(\mathrm{2},\Varid{n}),\Varid{n}\div \Varid{smallestPrimeFactor}\;(\mathrm{2},\Varid{n})){}\<[E]%
\\[\blanklineskip]%
...
\column{5}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\mbox{\onelinecomment  mergeTrees}{}\<[E]%
\\
\>[B]{}\Varid{mergeTrees}\mathbin{::}(\Conid{Exp}\;\mathbb{Z}\;\mathbb{Z},\Conid{Exp}\;\mathbb{Z}\;\mathbb{Z})\to \Conid{Exp}\;\mathbb{Z}\;\mathbb{Z}{}\<[E]%
\\
\>[B]{}\Varid{mergeTrees}\;(\Conid{Var}\;\Varid{v1},\Conid{Var}\;\Varid{v2})\mathrel{=}\Conid{Term}\;\mathrm{1}\;[\mskip1.5mu \Conid{Var}\;\Varid{v1},\Conid{Var}\;\Varid{v2}\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{mergeTrees}\;(\Conid{Var}\;\Varid{v},\Conid{Term}\;\Varid{o}\;\Varid{sub})\mathrel{=}\Conid{Term}\;\Varid{o}\;(\Conid{Var}\;\Varid{v}\mathbin{:}\Varid{sub}){}\<[E]%
\\
\>[B]{}\Varid{mergeTrees}\;(\Conid{Term}\;\Varid{o}\;\Varid{sub},\Conid{Var}\;\Varid{v})\mathrel{=}\Conid{Term}\;\Varid{o}\;(\Varid{sub}\mathbin{+\!\!+}[\mskip1.5mu \Conid{Var}\;\Varid{v}\mskip1.5mu]){}\<[E]%
\\
\>[B]{}\Varid{mergeTrees}\;(\Conid{Term}\;\Varid{o1}\;\Varid{sub1},\Conid{Term}\;\Varid{o2}\;\Varid{sub2}){}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mid \Varid{o1}\equiv \Varid{o2}\mathrel{=}\Conid{Term}\;\Varid{o1}\;(\Varid{mergeSubtrees}\;\Varid{sub1}\;\Varid{sub2}){}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mid \Varid{otherwise}\mathrel{=}\Conid{Term}\;\mathrm{1}\;[\mskip1.5mu \Conid{Term}\;\Varid{o1}\;\Varid{sub1},\Conid{Term}\;\Varid{o2}\;\Varid{sub2}\mskip1.5mu]{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{mergeSubtrees}\mathbin{::}[\mskip1.5mu \Conid{Exp}\;\mathbb{Z}\;\mathbb{Z}\mskip1.5mu]\to [\mskip1.5mu \Conid{Exp}\;\mathbb{Z}\;\mathbb{Z}\mskip1.5mu]\to [\mskip1.5mu \Conid{Exp}\;\mathbb{Z}\;\mathbb{Z}\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{mergeSubtrees}\;[\mskip1.5mu \mskip1.5mu]\;\Varid{t2}\mathrel{=}\Varid{t2}{}\<[E]%
\\
\>[B]{}\Varid{mergeSubtrees}\;\Varid{t1}\;[\mskip1.5mu \mskip1.5mu]\mathrel{=}\Varid{t1}{}\<[E]%
\\
\>[B]{}\Varid{mergeSubtrees}\;(\Varid{x}\mathbin{:}\Varid{xs})\;\Varid{ys}\mathrel{=}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mathbf{case}\;\Varid{find}\;(\Varid{sameRoot}\;\Varid{x})\;\Varid{ys}\;\mathbf{of}{}\<[E]%
\\
\>[3]{}\hsindent{2}{}\<[5]%
\>[5]{}\Conid{Just}\;\Varid{y}\to \Varid{mergeTrees}\;(\Varid{x},\Varid{y})\mathbin{:}\Varid{mergeSubtrees}\;\Varid{xs}\;(\Varid{filter}\;(\not\equiv \Varid{y})\;\Varid{ys}){}\<[E]%
\\
\>[3]{}\hsindent{2}{}\<[5]%
\>[5]{}\Conid{Nothing}\to \Varid{x}\mathbin{:}\Varid{mergeSubtrees}\;\Varid{xs}\;\Varid{ys}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\mbox{\onelinecomment  Checks if two trees have the same root}{}\<[E]%
\\
\>[B]{}\Varid{sameRoot}\mathbin{::}\Conid{Exp}\;\mathbb{Z}\;\mathbb{Z}\to \Conid{Exp}\;\mathbb{Z}\;\mathbb{Z}\to \Conid{Bool}{}\<[E]%
\\
\>[B]{}\Varid{sameRoot}\;(\Conid{Term}\;\Varid{o1}\;\anonymous )\;(\Conid{Term}\;\Varid{o2}\;\anonymous )\mathrel{=}\Varid{o1}\equiv \Varid{o2}{}\<[E]%
\\
\>[B]{}\Varid{sameRoot}\;\anonymous \;\anonymous \mathrel{=}\Conid{False}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\mbox{\onelinecomment  Generate a tree with a prime number as root and its prime factors as children}{}\<[E]%
\\
\>[B]{}\Varid{primeTree}\mathbin{::}\mathbb{Z}\to \Conid{Exp}\;\mathbb{Z}\;\mathbb{Z}{}\<[E]%
\\
\>[B]{}\Varid{primeTree}\;\Varid{n}\mathrel{=}\Conid{Term}\;\mathrm{1}\;(\Varid{myfoldr}\;\Varid{buildTree}\;[\mskip1.5mu \Conid{Var}\;\Varid{n}\mskip1.5mu]\;(\Varid{primes}\;\Varid{n})){}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mathbf{where}{}\<[E]%
\\
\>[3]{}\hsindent{2}{}\<[5]%
\>[5]{}\Varid{buildTree}\;\Varid{prime}\;\Varid{acc}\mathrel{=}[\mskip1.5mu \Conid{Term}\;\Varid{prime}\;\Varid{acc}\mskip1.5mu]{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{geneCata}\mathbin{::}()+(\Conid{Exp}\;\mathbb{Z}\;\mathbb{Z},\Conid{Exp}\;\mathbb{Z}\;\mathbb{Z})\to \Conid{Exp}\;\mathbb{Z}\;\mathbb{Z}{}\<[E]%
\\
\>[B]{}\Varid{geneCata}\mathrel{=}\alt{\underline{\Conid{Term}\;\mathrm{1}\;[\mskip1.5mu \mskip1.5mu]}}{\Varid{mergeTrees}}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{geneAna}\mathbin{::}[\mskip1.5mu \mathbb{Z}\mskip1.5mu]\to ()+(\Conid{Exp}\;\mathbb{Z}\;\mathbb{Z},[\mskip1.5mu \mathbb{Z}\mskip1.5mu]){}\<[E]%
\\
\>[B]{}\Varid{geneAna}\;[\mskip1.5mu \mskip1.5mu]\mathrel{=}i_1\;(){}\<[E]%
\\
\>[B]{}\Varid{geneAna}\;(\Varid{x}\mathbin{:}\Varid{xs})\mathrel{=}i_2\;(\Varid{primeTree}\;\Varid{x},\Varid{xs}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{prime\char95 tree}\mathrel{=}\Varid{hyloList}\;\Varid{geneCata}\;\Varid{geneAna}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\>[B]{}\Varid{convolve}\mathbin{::}\Conid{Num}\;\Varid{a}\Rightarrow [\mskip1.5mu \Varid{a}\mskip1.5mu]\to [\mskip1.5mu \Varid{a}\mskip1.5mu]\to [\mskip1.5mu \Varid{a}\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{convolve}\mathrel{=}\bot {}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{cataExpr}\mathbin{::}(\Varid{b2}+(\Varid{b3}+(\Conid{Op},[\mskip1.5mu \Varid{b1}\mskip1.5mu]))\to \Varid{b1})\to \Conid{Expr}\;\Varid{b3}\;\Varid{b2}\to \Varid{b1}{}\<[E]%
\\
\>[B]{}\Varid{cataExpr}\;\Varid{g}\mathrel{=}\Varid{g}\comp \Varid{recExpr}\;(\Varid{cataExpr}\;\Varid{g})\comp \Varid{outExpr}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{anaExpr}\mathbin{::}(\Varid{a1}\to \Varid{a2}+(\Varid{b}+(\Conid{Op},[\mskip1.5mu \Varid{a1}\mskip1.5mu])))\to \Varid{a1}\to \Conid{Expr}\;\Varid{b}\;\Varid{a2}{}\<[E]%
\\
\>[B]{}\Varid{anaExpr}\;\Varid{g}\mathrel{=}\Varid{inExpr}\comp \Varid{recExpr}\;(\Varid{anaExpr}\;\Varid{g})\comp \Varid{g}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{hyloExpr}\mathbin{::}(\Varid{b2}+(\Varid{b3}+(\Conid{Op},[\mskip1.5mu \Varid{c}\mskip1.5mu]))\to \Varid{c})\to (\Varid{a}\to \Varid{b2}+(\Varid{b3}+(\Conid{Op},[\mskip1.5mu \Varid{a}\mskip1.5mu])))\to \Varid{a}\to \Varid{c}{}\<[E]%
\\
...
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mathsf{fmap}\;\Varid{f}\;(\Conid{V}\;\Varid{a})\mathrel{=}\Conid{V}\;(\Varid{f}\;\Varid{a}){}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mathsf{fmap}\;\anonymous \;(\Conid{N}\;\Varid{b})\mathrel{=}\Conid{N}\;\Varid{b}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mathsf{fmap}\;\Varid{f}\;(\Conid{T}\;\Varid{op}\;\Varid{exprs})\mathrel{=}\Conid{T}\;\Varid{op}\;(\map \;(\mathsf{fmap}\;\Varid{f})\;\Varid{exprs}){}\<[E]%
\\[\blanklineskip]%
