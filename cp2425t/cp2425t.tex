...
No caso do \ensuremath{\Varid{evaluate}}, o gene \ensuremath{\Varid{gene}} define como é que se processa cada nó da estrutura \ensuremath{\Conid{Expr}}.
O gene \ensuremath{\Varid{gene}} lida com três casos principais:
\begin{itemize}
\item \ensuremath{\Conid{V}} : Para uma variável, retornamos \ensuremath{\Conid{Nothing}}, porque as variávis não podem ser avaliadas.
