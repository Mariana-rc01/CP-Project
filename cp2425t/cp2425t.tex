...
\column{9}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{hindex}\mathrel{=}\Varid{hyloBTree}\;\alt{\Varid{f1}}{\Varid{f2}}\;\Varid{qsep}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{f1}\mathrel{=}\underline{\mathrm{0},[\mskip1.5mu \mskip1.5mu]}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{f2}\mathbin{::}(\Conid{Int},((\Conid{Int},[\mskip1.5mu \Conid{Int}\mskip1.5mu]),(\Conid{Int},[\mskip1.5mu \Conid{Int}\mskip1.5mu])))\to (\Conid{Int},[\mskip1.5mu \Conid{Int}\mskip1.5mu]){}\<[E]%
\\
\>[B]{}\Varid{f2}\;(\Varid{n},((\anonymous ,\Varid{ll}),(\anonymous ,\Varid{lr})))\mathrel{=}(\Varid{hIndex},\Varid{contributors}){}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\mathbf{where}{}\<[E]%
\\
...
\\
     \ensuremath{\mathbb{Z}}^*
            \ar@/_/[r]_-{\ensuremath{\Varid{outList}}} 
&
     \ensuremath{\mathrm{1}\mathbin{+}\mathbb{Z}} \times \ensuremath{\mathbb{Z}}^*
           \ar@/_/[l]_-{\ensuremath{\Varid{inList}}}
}
\end{eqnarray*}
...
2. Neste contexto, a função \ensuremath{\Varid{untar}} converte os fatores primos de um número e o próprio número numa representação de árvore onde os nós intermediários são os fatores e as folhas são os números originais, \ensuremath{[\mskip1.5mu \Conid{Exp}\;\mathbb{Z}\;\mathbb{Z}\mskip1.5mu]}.
...
2.3. Para finalizar, a álgebra \ensuremath{\Varid{a}} organiza os dados processados na estrutura final, a operação \ensuremath{\Varid{sort}} organiza os nós, enquanto que o \ensuremath{\map \;\Varid{inExp}} converte os elementos numa estrutura do tipo \ensuremath{\Conid{Exp}\;\mathbb{Z}\;\mathbb{Z}}.
...
\\
\>[B]{}\Varid{result}\;\Conid{Add}\mathrel{=}\Conid{Just}\comp \Varid{sum}{}\<[E]%
\\
\>[B]{}\Varid{result}\;\Conid{Mul}\mathrel{=}\Conid{Just}\comp \Varid{product}{}\<[E]%
\\
\>[B]{}\Varid{result}\;\Conid{Suc}\mathrel{=}\Conid{Just}\comp (\mathbin{+}\mathrm{1})\comp \Varid{head}{}\<[E]%
\\
\>[B]{}\Varid{result}\;\Conid{ITE}\mathrel{=}\Conid{Just}\comp \Varid{cond}\;(\uncurry{(\mathbin{>})}\comp \conj{\Varid{head}}{\underline{\mathrm{0}}})\;(\uncurry{(\mathbin{!!})}\comp \conj{\Varid{id}}{\underline{\mathrm{1}}})\;(\uncurry{(\mathbin{!!})}\comp \conj{\Varid{id}}{\underline{\mathrm{2}}}){}\<[E]%
\\
\>[B]{}\Varid{result}\;\anonymous \mathrel{=}\underline{\Conid{Nothing}}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
